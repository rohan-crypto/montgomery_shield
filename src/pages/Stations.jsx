  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        />
        <StatCard
          title="Police Facilities"
          value={policeStations.length}
          subtitle="Stations + substations"
          icon={Shield}
          color="blue"
        />
        <StatCard
          title="Officers (2024)"
          value="280"
          subtitle="Down 42% from 2020"
          icon={AlertTriangle}
          color="yellow"
          trend={{ up: true, text: 'Critical staffing shortage' }}
        />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-xl p-4">
          <h3 className="text-white font-semibold mb-4 flex items-center gap-2">
            ...
            Fire Stations
            <span className="ml-auto text-xs bg-red-500/10 border border-red-500/30
          ...
          <div className="relative">
            <div
              ref={fireRef}
              className="grid grid-cols-2 gap-2 max-h-72 overflow-y-auto
                         pr-1 scroll-smooth"
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-xl p-4">
          <h3 className="text-white font-semibold mb-4 flex items-center gap-2">
            ...
            Police Facilities
            <span className="ml-auto text-xs bg-blue-500/10 border border-blue-500/30
                             text-blue-400 px-2 py-0.5 rounded-full">
              ...
              {policeStations.map((s, idx) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-blue-400 text-xs font-bold leading-snug">
                      {s.Facility_Name}
                    </span>
                  </div>
                  <p className="text-slate-400 text-xs leading-snug">
      ...
      <div className="bg-gradient-to-r from-red-900/30 to-slate-800
                      border border-red-500/20 rounded-xl p-5">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              Montgomery has {stations.length} fire and police facilities across
              the city — but only 280 active police officers to staff them, down
              from 485 in 2020. That's a 42% collapse in 4 years. Officers are
              leaving at 2-3 per week. More facilities exist than can be
              adequately staffed, creating dangerous coverage gaps across districts.
            </p>
            <div className="flex gap-3 mt-3">
              <span className="text-xs bg-red-500/20 text-red-300
                               px-3 py-1 rounded-full border border-red-500/30">
                280 Active Officers
              </span>
              <span className="text-xs bg-yellow-500/20 text-yellow-300
                               px-3 py-1 rounded-full border border-yellow-500/30">
                Down from 485 in 2020
              </span>
              <span className="text-xs bg-slate-500/20 text-slate-300
                               px-3 py-1 rounded-full border border-slate-500/30">
                2-3 Leaving Per Week
              </span>
            </div>
          </div>
        </div>
